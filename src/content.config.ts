...
import { DEFAULT_PASSWORD, DEFAULT_QUESTION } from "@contentConsts";
...
const vault = defineCollection({
  ...
  schema: ({ image }) =>
    baseSchema.extend({
      ...
      question: z.string().optional().default(DEFAULT_QUESTION),
      password: z
        .string()
        .regex(
          /[a-zA-Z0-9!@#$%^&*]/,
...
export const collections = { article, vault, author };
